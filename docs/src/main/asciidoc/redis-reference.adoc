...
The key, value (string), hash, list, set, sorted set and bitmap command groups are implemented on the Lettuce backend,
including their transactional variants. The other groups (geo, hyperloglog, stream, pub/sub, JSON, bloom,
