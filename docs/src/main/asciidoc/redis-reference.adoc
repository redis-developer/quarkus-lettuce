...
The key, value (string), hash, list, set and sorted set command groups are implemented on the Lettuce backend,
including their transactional variants. The other groups (geo, hyperloglog, bitmap, stream, pub/sub, JSON, bloom,
