...
The key, value (string), hash, list, set, sorted set, bitmap and hyperloglog command groups are implemented on the
Lettuce backend, including their transactional variants. The other groups (geo, stream, pub/sub, JSON, bloom,
