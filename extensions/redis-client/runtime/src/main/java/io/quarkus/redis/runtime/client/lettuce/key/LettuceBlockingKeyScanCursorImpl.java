...
/**
 * Blocking wrapper around {@link LettuceReactiveKeyScanCursorImpl}. Each method awaits the
 * reactive cursor's emission for the configured {@code timeout}. Must not be invoked from
 * an event loop thread.
 */
public class LettuceBlockingKeyScanCursorImpl<K> implements KeyScanCursor<K> {

    private final ReactiveKeyScanCursor<K> reactive;
    private final Duration timeout;

    public LettuceBlockingKeyScanCursorImpl(ReactiveKeyScanCursor<K> reactive, Duration timeout) {
